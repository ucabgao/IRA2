...
CBCentralManagerDelegate.addMethod('centralManager:didDiscoverPeripheral:advertisementData:RSSI:', 'v@:@@@@', function ($self, $_cmd, $centralManager, $peripheral, $advertisementData, $RSSI) {
...
CBCentralManagerDelegate.addMethod('centralManager:didConnectPeripheral:', 'v@:@@', function ($self, $_cmd, $centralManager, $peripheral) {
    var identifier = $util.identifierFor$Peripheral($peripheral);
...
CBCentralManagerDelegate.addMethod('centralManager:didDisconnectPeripheral:error:', 'v@:@@@', function ($self, $_cmd, $centralManager, $peripheral, $error) {
    var identifier = $util.identifierFor$Peripheral($peripheral);
...
CBCentralManagerDelegate.addMethod('centralManager:didFailToConnectPeripheral:error:', 'v@:@@@', function ($self, $_cmd, $centralManager, $peripheral, $error) {
    var identifier = $util.identifierFor$Peripheral($peripheral);
    var error = $util.toError($error);
